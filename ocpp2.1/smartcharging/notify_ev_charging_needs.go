...
func isValidEnergyTransferMode(fl validator.FieldLevel) bool {
	...
	switch status {
	case types.EnergyTransferModeAC1Phase, types.EnergyTransferModeAC2Phase, types.EnergyTransferModeAC3Phase,
		types.EnergyTransferModeDC, types.EnergyTransferModeACBPT, types.EnergyTransferModeACBPTDER,
		types.EnergyTransferModeACDER, types.EnergyTransferModeDCBPT, types.EnergyTransferModeDCACDP,
		types.EnergyTransferModeDCACDPBPT, types.EnergyTransferModeWPT:
		return true
	default:
		return false
	}
