...
import (
	...
	ocppj "github.com/xBlaz3kx/ocpp-go/ocppj"
)
...
func (_m *MockServerQueueMap) Size() int {
	ret := _m.Called()
...
// MockServerQueueMap_Size_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Size'
type MockServerQueueMap_Size_Call struct {
	*mock.Call
}

// Size is a helper method to define mock.On call
func (_e *MockServerQueueMap_Expecter) Size() *MockServerQueueMap_Size_Call {
	return &MockServerQueueMap_Size_Call{Call: _e.mock.On("Size")}
}

func (_c *MockServerQueueMap_Size_Call) Run(run func()) *MockServerQueueMap_Size_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockServerQueueMap_Size_Call) Return(_a0 int) *MockServerQueueMap_Size_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockServerQueueMap_Size_Call) RunAndReturn(run func() int) *MockServerQueueMap_Size_Call {
	_c.Call.Return(run)
	return _c
}

// SizePerClient provides a mock function with no fields
func (_m *MockServerQueueMap) SizePerClient() map[string]int {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for SizePerClient")
	}
...
// MockServerQueueMap_SizePerClient_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SizePerClient'
type MockServerQueueMap_SizePerClient_Call struct {
	*mock.Call
}

// SizePerClient is a helper method to define mock.On call
func (_e *MockServerQueueMap_Expecter) SizePerClient() *MockServerQueueMap_SizePerClient_Call {
	return &MockServerQueueMap_SizePerClient_Call{Call: _e.mock.On("SizePerClient")}
}

func (_c *MockServerQueueMap_SizePerClient_Call) Run(run func()) *MockServerQueueMap_SizePerClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockServerQueueMap_SizePerClient_Call) Return(_a0 map[string]int) *MockServerQueueMap_SizePerClient_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockServerQueueMap_SizePerClient_Call) RunAndReturn(run func() map[string]int) *MockServerQueueMap_SizePerClient_Call {
	_c.Call.Return(run)
	return _c
}
