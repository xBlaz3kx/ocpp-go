...
// Note: Using interface{} since client is unexported
func (_m *MockClientOpt) Execute(c interface{}) {
	_m.Called(c)
}
...
func (_c *MockClientOpt_Execute_Call) Run(run func(c interface{})) *MockClientOpt_Execute_Call {
...
func (_c *MockClientOpt_Execute_Call) RunAndReturn(run func(interface{})) *MockClientOpt_Execute_Call {
	_c.Run(run)
	return _c
}
