...
import (
	...
	ws "github.com/xBlaz3kx/ocpp-go/ws"
)
...
func (_m *MockWsServer) Connections(websocketId string) ws.Channel {
...
func (_c *MockWsServer_Connections_Call) Return(_a0 ws.Channel) *MockWsServer_Connections_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWsServer_Connections_Call) RunAndReturn(run func(string) ws.Channel) *MockWsServer_Connections_Call {
	_c.Call.Return(run)
	return _c
}
